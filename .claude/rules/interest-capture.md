...
1. 运行 `python -m scholar interests logs` 获取未分析的对话日志（按项目分组显示）
2. 阅读每个项目的日志，识别研究方向信号：
...
5. 运行 `python -m scholar interests mark-analyzed --week YYYY-WNN --found N --project "项目名"` 标记完成
