...
## 简介
本文件系统性阐述研究技能系统的架构与实现，覆盖22项研究技能：其中8项原子技能负责数据处理、解析、验证与执行；6项工作流以原子技能为拼装单元，形成端到端的研究流程。文档还涵盖MCP协议在技能系统中的作用、与Qoder IDE的集成方式、技能开发指南、测试与调试方法，以及配置与扩展最佳实践。
...
Design --> ExpDesign["实验设计<br/>基准/指标/数据集/消融实验"]
