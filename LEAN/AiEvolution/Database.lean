...
def citationsDb : List Citation := [
  { from := "BERT", to := "Attention_Is_All_You_Need" },
  { from := "GPT2", to := "GPT" },
  { from := "GPT3", to := "GPT2" },
  { from := "T5", to := "BERT" },
  { from := "DeBERTa", to := "BERT" },
  { from := "Decoder_Only", to := "Transformer" },
  { from := "Mamba", to := "Transformer" },
  { from := "LoRA_Algorithm", to := "Transformer" },
  { from := "QLoRA", to := "LoRA_Algorithm" },
  { from := "Flash_Attention", to := "Transformer" },
  { from := "Speculative_Decoding", to := "Decoder_Only" },
  { from := "MoE", to := "Transformer" },
  { from := "Switch_Transformer", to := "MoE" },
  { from := "DPO_Loss", to := "PPO_Objective" },
  { from := "DPO_Loss", to := "RLHF" },
  { from := "KTO", to := "DPO_Loss" },
  { from := "ORPO", to := "DPO_Loss" },
  { from := "RLHF", to := "PPO_Objective" },
  { from := "Constitutional_AI", to := "RLHF" },
  { from := "Instruct_Tuning", to := "GPT3" },
  { from := "Diffusion_Architecture", to := "GAN_Architecture" },
  { from := "Diffusion_Architecture", to := "VAE" },
  { from := "Latent_Diffusion", to := "Diffusion_Architecture" },
  { from := "Stable_Diffusion", to := "Latent_Diffusion" },
  { from := "Score_Matching", to := "Diffusion_Architecture" },
  { from := "Classifier_Free_Guidance", to := "Diffusion_Architecture" },
  { from := "Flow_Matching_Objective", to := "Diffusion_Architecture" },
  { from := "Consistency_Model", to := "Diffusion_Architecture" },
  { from := "StyleGAN", to := "GAN_Architecture" },
  { from := "ViT", to := "Transformer" },
  { from := "ViT", to := "ResNet" },
  { from := "DINOv2", to := "ViT" },
  { from := "SAM", to := "ViT" },
  { from := "ConvNeXt", to := "ResNet" },
  { from := "ConvNeXt", to := "ViT" },
  { from := "EfficientNet", to := "CNN" },
  { from := "CLIP", to := "Transformer" },
  { from := "CLIP", to := "ResNet" },
  { from := "Flamingo", to := "CLIP" },
  { from := "Flamingo", to := "GPT3" },
  { from := "LLaVA", to := "CLIP" },
  { from := "LLaVA", to := "LLaMA" },
  { from := "BLIP2", to := "CLIP" },
  { from := "GPT4V", to := "GPT3" },
  { from := "Qwen_VL", to := "CLIP" },
  { from := "CogVLM", to := "CLIP" },
  { from := "Chain_of_Thought", to := "GPT3" },
  { from := "ReAct", to := "Chain_of_Thought" },
  { from := "Tree_of_Thought", to := "Chain_of_Thought" },
  { from := "Reflexion", to := "ReAct" },
  { from := "Self_Consistency", to := "Chain_of_Thought" },
  { from := "Tool_Use", to := "GPT3" },
  { from := "Multi_Agent", to := "ReAct" },
  { from := "LSTM", to := "RNN" },
  { from := "GRU", to := "RNN" },
  { from := "Seq2Seq", to := "RNN" },
  { from := "Bahdanau_Attention", to := "Seq2Seq" },
  { from := "Transformer", to := "Bahdanau_Attention" },
  { from := "Dense_Passage_Retrieval", to := "BERT" },
  { from := "ColBERT", to := "BERT" },
  { from := "RAG_Framework", to := "BERT" },
  { from := "RAG_Framework", to := "Dense_Passage_Retrieval" },
  { from := "E5_Embedding", to := "BERT" },
  { from := "BGE_Embedding", to := "BERT" },
  { from := "Sentence_Transformers", to := "BERT" },
  { from := "GAT", to := "GCN" },
  { from := "GraphSAGE", to := "GCN" },
  { from := "GIN", to := "GCN" },
  { from := "AdamW", to := "Adam" },
  { from := "LAMB", to := "Adam" },
  { from := "Lion", to := "Adam" },
  { from := "Chinchilla", to := "Kaplan_Law" },
  { from := "Emergent_Abilities", to := "Kaplan_Law" },
  { from := "Grokking", to := "Double_Descent" },
  { from := "RLHF_Safety", to := "RLHF" },
  { from := "Red_Teaming", to := "RLHF_Safety" },
  { from := "Constitutional_AI_Safety", to := "Constitutional_AI" },
  { from := "DPO_Safety", to := "DPO_Loss" },
  { from := "Guardrails", to := "RLHF_Safety" },
  { from := "Watermarking", to := "GPT3" },
  { from := "Wav2Vec2", to := "BERT" },
  { from := "Whisper", to := "GPT3" },
  { from := "EnCodec", to := "VAE" },
  { from := "Copilot", to := "GPT3" },
  { from := "CodeLLaMA", to := "LLaMA" },
  { from := "StarCoder", to := "GPT3" },
  { from := "MAML", to := "Adam" },
  { from := "Prototypical_Networks", to := "MAML" },
  { from := "Rainbow_DQN", to := "DQN" },
  { from := "A3C", to := "Policy_Gradient" },
  { from := "SAC", to := "Policy_Gradient" },
  { from := "TD3", to := "SAC" },
  { from := "MuZero", to := "DQN" },
  { from := "Dreamer", to := "MuZero" },
  { from := "QLoRA", to := "Quantization" },
  { from := "INT8_Quantization", to := "Quantization" },
  { from := "Knowledge_Distillation", to := "ResNet" },
  { from := "Pruning", to := "CNN" },
  { from := "MAE", to := "ViT" },
  { from := "SimCLR", to := "ResNet" },
  { from := "BYOL", to := "SimCLR" },
  { from := "Word2Vec", to := "RNN" },
  { from := "BERT", to := "Word2Vec" },
  { from := "GPT", to := "Transformer" },
  { from := "GPT", to := "Word2Vec" }
]
...
def replacesDb : List Replacement := [
  ...
  { from := "GAN_Architecture", to := "Diffusion_Architecture" },
  { from := "PPO_Objective", to := "DPO_Loss" },
  { from := "CNN", to := "ViT" },
  { from := "BM25", to := "Dense_Passage_Retrieval" },
  { from := "VAE", to := "Diffusion_Architecture" },
  { from := "StyleGAN", to := "Latent_Diffusion" },
  { from := "Seq2Seq", to := "Transformer" },
  { from := "SGD_Momentum", to := "Adam" },
  { from := "Adam", to := "AdamW" },
  { from := "MAML", to := "Reptile" },
  { from := "GCN", to := "GAT" },
  { from := "DQN", to := "Rainbow_DQN" },
  { from := "Policy_Gradient", to := "SAC" },
  { from := "WaveNet", to := "Whisper" },
  { from := "Pruning", to := "LoRA_Algorithm" },
  { from := "Quantization", to := "QLoRA" },
  { from := "Knowledge_Distillation", to := "LoRA_Algorithm" }
]
